...
// user read notification
   ...
   /* ================== Dynamic Page Functions ======================= */
	...
	public function storepage(Request $request){
		...
		DB::table('admin_pages')->insert(array('page_title' => $request->page_title, 'page_key' => $keyword_key, 'menu_id' => $request->menu));
	...
	public function updatepage(Request $request){
		...
		DB::table('admin_pages')
			...
			->update(array( 'page_title' => $request->page_title, 'menu_id' => $request->menu));
		$this->writelanguagefile('cms');		
