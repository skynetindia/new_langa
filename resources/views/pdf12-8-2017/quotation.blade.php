...
<table class="main-wrapper" cellpadding="0" cellspacing="0" >
        ...
        <tr>
            <td style="padding:0cm 1cm;">
                <table  style="margin:0 auto; max-width:100%" width="100%" align="center" cellpadding="0" cellspacing="0" autosize="1">
                    <tr>
        ...
        <tr>
          ...
          <tr>
            <td style="padding:0.53cm 1cm 0;">
                    <table  style="margin:0 auto;" width="100%" align="center" cellpadding="0" cellspacing="0" autosize="1">
                    <tr>
        ...
        $sconto = $preventivo->scontoagente . '% + ' . $preventivo->scontobonus . '% ( € '.number_format($valoresconto1,2) . ' + € ' .number_format($valoresconto2,2) . ' )'." ";
                            ...
                            <td colspan="3" style=" background-color:#f5f3f4; padding:0.1cm; line-height:1.3; border:0.03cm solid #fff; text-align:right;" valign="middle"><?php $daPagare = $preventivo->totaledapagare;
                                    echo "€ ".number_format($daPagare,2);
                                    foreach($taxation as $taxationKey => $taxationval) {
                                        $percentagamount = (($daPagare * $taxationval->tassazione_percentuale) / 100);
                                        echo " + ".number_format($percentagamount,2)." ".$taxationval->tassazione_nome;
                                    }
                                    ?></td>
                       </tr></table>
                         </td>
        ...
        <tr>
        	<td style="padding:0.53cm 1cm 0;">
            	<table  style="margin:0 auto;" width="100%" cellspacing="0" cellpadding="0" align="center" autosize="1">
                	<tbody><tr>
