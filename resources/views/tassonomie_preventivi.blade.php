		...
		<div class="form-group">
                ...
                <div class="col-xs-6 col-sm-3">    
                    ...
                    <div class="col-xs-6 col-sm-3">
                        ...
                        <a onclick="conferma(event);" type="submit" href="{{url('admin/taxonomies/statiestimate/delete/id' . '/' . $estimatestype->id)}}" class="btn danger"><button type="button" class="btn btn-danger">{{trans('messages.keyword_clear')}}</button></a></td>
                    </div>	
				</div>
			</form>
		</tr>
