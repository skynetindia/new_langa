        ...
        <td>
            ...
            <table class="table sub-table">
              ...
              <td>
                ...
                <td><input type="text" class="form-control" name="name[{{$estimatestype->id}}]" id="name" value="<?php echo ($estimatestype->language_key != "") ? trans('messages.'.$estimatestype->language_key) : $estimatestype->name; ?>">
                <input type="hidden" name="langkey[{{$estimatestype->id}}]" value="{{$estimatestype->language_key}}"></td>
