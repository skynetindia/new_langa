        ...
        <td>
            ...
            <table class="table sub-table">
              <tr>
                ...
                <td><input type="text" class="form-control" name="name[{{$types->id}}]" id="name" value="<?php echo ($types->language_key != "") ? trans('messages.'.$types->language_key) : $types->name; ?>">
                <input type="hidden" name="langkey[{{$types->id}}]" value="{{$types->language_key}}"></td>
        ...
        <td>
            ...
            <table class="table sub-table">
              ...
              <td>
                ...
                <td><input type="text" class="form-control" name="name[{{$emostatetye->id}}]" id="name" value="<?php echo ($emostatetye->language_key != "") ? trans('messages.'.$emostatetye->language_key) : $emostatetye->name; ?> ">
                <input type="hidden" name="langkey[{{$emostatetye->id}}]" value="{{$emostatetye->language_key}}"></td>
