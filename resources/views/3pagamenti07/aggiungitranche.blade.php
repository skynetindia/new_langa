...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="col-md-8">
		    ...
		    <select name="legameprogetto" id="legameprogetto" class="js-example-basic-single form-control required-input error">
		       <option></option>
...
<br><br>
	...
	<input type="hidden" name="id_disposizione" value="{{$idfattura}}"> 
	   ...
	   <label for="sedelegaleentea"> {{ trans('messages.keyword_registered_office_to') }}  </label>
	    ...
	    <input value="{{old('emissione')}}" type="text" name="emissione" id="emissione" class="form-control required-input error"><br>
	...
	<div class="col-md-4">
		...
		<br>
		  ...
		  <span class="fa fa-eye-slash" title="{{ trans('messages.keyword_ifso') }} "></span>
			...
			<br><label for="percentuale">% {{ trans('messages.keyword_total_amount') }} </label>
			<input id="percentuale" name="percentuale" class="form-control required-input error" value="{{old('percentuale')}}" placeholder="% {{ trans('messages.keyword_description') }}">
			...
			<br><label for="datascadenza"> {{ trans('messages.keyword_expiry_date_invoice') }} </label><br>
		    <input value="{{old('datascadenza')}}" class="form-control required-input error" name="datascadenza" id="datascadenza"></input><br>
		    <script>
		    $j('#frequenza').hide();
			$j('#percentualediv').hide();
