    ...
    <tbody>
            ...
            <table width="100%">
                <tr>
                    <td valign="top" style="" align="left">
                        <img src="{{asset('images/pdfimages/logo.jpg')}}" width="100" height="100" alt="Logo"/>
                    </td>
        ...
        <tr>
            <td style="border-bottom:2px solid #000;border-top:2px solid #000;">
                <p style="margin:0px; text-align:center; padding:7px; font-size:11px;"><?php 
                    ...
                    <tbody><tr>
                        <td width="50%" valign="middle" align="left" style="border-right: 2px solid #000;">
                            <table width="100%" cellspacing="0" cellpadding="0" style="padding:10px 6px;">
                                ...
                                <tr>
                                    <td style="font-size:12px; padding-top:10px;">{{$ente_A->sedelegale}}</td>
                                </tr>
                            </tbody></table>
                         </td>
        ...
        <tr>
            <td style="font-size:12px; padding-top:28px; line-height:25px;">
                ...
                {{trans('messages.keyword_payment_methods')}}: <b><span style="border-bottom:2px dotted #323232; padding:0px 15px;">{{$tranche->modalita}}</span></b> {{trans('messages.keyword_with_the_disposal_of')}} <b><span style="color:#f38400; border-bottom:2px dotted #323232; padding:0px 15px;">{{$tranche->datascadenza}}</span></b> {{trans('messages.keyword_in_favor_of_companies_on_iban')}} <b><span style="border-bottom:2px dotted #323232; padding:0px 15px;">{{$tranche->iban}}</span></b><br/>
            ...
            <td>
                <table style="margin-top:15px; border:2px solid #000; font-size:12px;" width="100%" cellspacing="0" cellpadding="0" align="center">
                    <tbody>
                        ...
                        <tr>
                            <td style="border-bottom:2px solid #000; border-right:2px solid #cdcdcd; padding:3px 7px;">{{$corpofatturas->ordine}}</td>
                            <td style="border-bottom:2px solid #000; border-right:2px solid #cdcdcd; padding:3px 7px;">{{$corpofatturas->descrizione}}</td>
                            <td style="border-bottom:2px solid #000; border-right:2px solid #cdcdcd; padding:3px 7px;">{{$corpofatturas->qta}}</td>
                            <td style="border-bottom:2px solid #000; border-right:2px solid #cdcdcd; padding:3px 7px;"><?php echo number_format($corpofatturas->subtotale,2)?></td>
                            <td style="border-bottom:2px solid #000;  padding:3px 7px;"><?php echo number_format($corpofatturas->netto,2)?></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
        ...
        ?><td>
                <table style="margin-top:15px; border:2px solid #000; font-size:12px;" width="100%" cellspacing="0" cellpadding="0" align="center">
                    <tbody>
                        ...
                        <tr>
                            <td  style="padding:3px 7px;">{{number_format($tranche->peso,2)}}</td>
                            <td  style="padding:3px 7px;">{{number_format($tranche->netto,2)}}</td>
                            <td  style="padding:3px 7px;">{{number_format($tranche->scontoaggiuntivo,2)}}</td>
                            <td  style="padding:3px 7px;">{{number_format($tranche->imponibile,2)}}</td>
                            <td  style="padding:3px 7px;">{{number_format($tranche->prezzoiva,2)}}</td>
                            <td  style="padding:3px 7px;">{{$tranche->percentualeiva}}</td>
                            <td  style="padding:3px 7px;">{{number_format($tranche->dapagare,2)}} €</td>
                        </tr>
                    </tbody>
                </table>
            </td>
