    <table class="main-wrapper" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td style="padding:0cm 1cm;">
                <table style="margin:0 auto;" width="100%" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="height:0.98cm; background-color:#34393d; font-size:0.48965556cm; color:#fff; width:49.9%; vertical-align:middle; padding-left:0.25cm;"> <strong>{{trans('messages.keyword_from')}} </strong></td>
                        <td width="0.2%" style="background-color:#fff">&nbsp;  </td>
                        <td style="height:0.98cm; background-color:#34393d; font-size:0.48965556cm; color:#fff; width:49.9%; vertical-align:middle; padding-left:0.25cm;"> <strong>{{trans('messages.keyword_to')}} </strong></td>
                    </tr>
                    <tr>
