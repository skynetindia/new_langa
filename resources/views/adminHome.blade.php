        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="{{url('/')}}" class="site_title"><img src="{{asset('images/logo.png')}}" alt="..." class="img" style="max-height:50px; max-width:50px"> <span>  Admin <strong>LANGA</strong></span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-user-times"></i> Ruoli e capacità <span class="fa fa-chevron-down"></span></a>
      ...
      if(typeof rfs!="undefined" && rfs){
        ...
        <footer>
          <div class="pull-right">
           2016 © Easy <strong>LANGA</strong> created by <a href="http://langa.tv" target="_blank"><strong>LANGA</strong></a>
          </div>
