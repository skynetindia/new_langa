...
<button class="btn btn-primary" type="button" name="create" title="{{ trans('messages.keyword_adddiscount') }}"><i class="glyphicon glyphicon-plus"></i></button>
...
<div class="table-responsive table-custom-design">
    ...
    <table data-toggle="table" data-search="true" data-pagination="true" data-id-field="id" data-show-refresh="true" data-show-columns="true" data-url="{{ url('/admin/sconti/json') }}" data-classes="table table-bordered" id="table">
        <thead>
