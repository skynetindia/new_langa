...
<div class="row">
  <div class="col-md-6"> <img src="http://easy.langa.tv/storage/app/images/<?php echo $dipartimento->logo; ?>" class="option-image">
    <h1 class="option-heading">  Codice: {{$dipartimento->id}}</h1>
  </div>
</div>
<hr>
<?php echo Form::open(array('url' => '/admin/tassonomie/dipartimenti/update/department/' . $dipartimento->id, 'files' => true)) ?> {{ csrf_field() }} 
<!-- colonna a sinistra -->
<div class="col-md-4">
  <label for="nomedipartimento">Nome dipartimento <span class="required">(*)</span></label>
  <input value="{{ $dipartimento->nomedipartimento }}" class="form-control" type="text" name="nomedipartimento" id="nomedipartimento" placeholder="Nome dipartimento">
  <br>
  <label for="piva">Partita iva</label>
  <input value="{{ $dipartimento->piva }}" class="form-control" type="text" name="piva" id="piva" placeholder="Partita iva">
  <br>
  <label for="cellulareazienda">Telefono dipartimento</label>
  <input value="{{ $dipartimento->cellularedipartimento }}" class="form-control" type="text" name="cellularedipartimento" id="cellulareazienda" placeholder="Telefono opzionale">
  <br>
  <label for="iban">IBAN</label>
  <input value="{{ $dipartimento->iban }}" class="form-control" type="text" name="iban" id="iban" placeholder="IBAN azienda">
  <br>
  <br>
</div>
<!-- colonna centrale -->
<div class="col-md-4">
  ...
  <input value="{{ $dipartimento->cf }}" class="form-control" type="text" name="cf" id="cf" placeholder="Codice fiscale">
  <br>
  <label for="fax">Fax</label>
  <input value="{{ $dipartimento->fax }}" class="form-control" type="text" name="fax" id="fax" placeholder="Fax">
  <br>
...
<div class="col-md-4">
  ...
  <input value="{{ $dipartimento->settore }}" list="settori" class="form-control" type="text" id="settore" name="settore" placeholder="Cerca un settore...">
  <br>
  <label for="telefonodipartimento">Telefono responsabile dipartimento</label>
  <input value="{{ $dipartimento->telefonodipartimento }}" class="form-control" type="text" name="telefonodipartimento" id="telefonodipartimento" placeholder="Telefono dipartimento">
  <br>
  <script>
  ...
  <input value="{{ $dipartimento->email }}" class="form-control" type="email" name="email" id="email" placeholder="Email di notifica">
  <br>
  <label for="emailsecondaria">Email secondaria</label>
  <input value="{{ $dipartimento->emailsecondaria }}" class="form-control" type="email" name="emailsecondaria" id="emailsecondaria" placeholder="Email opzionale">
  <br>
</div>
<div class="col-md-12"><label> Indirizzo <span class="required">(*)</span></label><br>
...
<div class="form-group">
  ...
  <textarea title="Note pubbliche per promemoria e info altri utenti" class="form-control" rows="7" name="noteenti" id="noteenti" placeholder="Note enti">{{ $dipartimento->noteenti }}</textarea>
</div>
</div>
<div class="col-xs-12">
