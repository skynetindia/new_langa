          ...
          <ul class="nav side-menu">
            ...
            <ul class="nav child_menu">
              <li><a>Tipi e stati<span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                  <li><a>Enti<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{url('/newenti')}}">New Enti</a> </li>
                      <li><a href="{{url('admin/tassonomie/enti')}}">Enti</a> </li>
                    </ul>
                  </li>
                  <li><a href="{{url('admin/tassonomie/preventivi')}}">Preventivi</a> </li>
                  <li><a>Progetti<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{url('/admin/tassonomie/progetti')}}">Progetti</a> </li>
                      <li><a href="{{url('admin/tassonomie/lavorazioni')}}">Lavorazioni</a> </li>
                    </ul>
                  </li>
                  <li><a href="{{url('/admin/tassonomie/pagamenti')}}">Pagamenti</a> </li>
                </ul>
              </li>
              <li>
              ...
              <ul class="nav child_menu">
                ...
                <li><a href="{{url('/admin/tassonomie/sconti/add')}}">Sconti</a> </li>
                <li><a href="{{url('/admin/tassonomie/scontibonus/add')}}">Sconti Bonus</a> </li>
