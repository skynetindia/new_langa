...
<a id="miei" class="button button2" onclick="callCalendarAjax(0);" name="miei" title="{{ trans('messages.keyword_eventfilter') }}">
    {{ trans('messages.keyword_my') }}
</a>
<a id="tutti" class="button button3" onclick="callCalendarAjax(1);"  name="tutti" title="{{ trans('messages.keyword_allevent') }} ">
 {{ trans('messages.keyword_all') }}
</a>
<a id="deadlines" class="button button2" onclick="callCalendarAjax(2);" name="miei" title="{{ trans('messages.keyword_eventfilter') }}">
    Deadlines
</a>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close btneventmodalclose" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-body">
                ...
                <form action="{{ url('/calendario/add') }}" method="post" id="eventform">
                    ...
                    <div class="row">
                        ...
                        <div class="input-group" id="mydaterangepicker">
                 ...
                 <!--   <legend> {{ trans('messages.keyword_schedule') }} </legend>-->
                    ...
                    <div class="modal-footer">
                        <input type="submit" class="btn btn-warning btneventmodalclose" value="{{ trans('messages.keyword_submit') }} ">
                    </div>
                </form>
...
function aggiungiEvento(selecteddate) {    
  $( "#newEvent" ).modal({ backdrop: 'static', keyboard: false });
    $('#newEvent').on('shown.bs.modal', function(){
        $(".widget-quotes").addClass('responsive-scroll-hide');
      initMap2();             
...
$(".btneventmodalclose").on("click",function(){
 $(".widget-quotes").removeClass('responsive-scroll-hide');          
});
...
$(".geolocationbox").click( function(e){
 ...
 function callCalendarAjax(type){    
    $.ajax({
        type:'POST',
        data: { 'type': type,'_token': '{{ csrf_token() }}' },
        url: '{{ url('dashboard/getcalendar') }}',
        success:function(data) {
            $("#calendat_ajax_part").html(data);
