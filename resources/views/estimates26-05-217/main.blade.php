...
@if(isset($miei))
<a id="miei" href="{{url('/estimates/my')}}" >
...
<button class="btn btn-warning" type="button" name="update" title="{{trans('messages.keyword_edit_the_last_selected_estimate')}}"><i class="fa fa-pencil"></i></button>
</a>

<a id="duplicate" onclick="multipleAction('duplicate');">
...
<a id="pdf" onclick="multipleAction('pdf');">
