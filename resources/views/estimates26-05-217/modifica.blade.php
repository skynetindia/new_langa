...
<input type="hidden" id="hdPrezzo" name="prezzo" value="{{$preventivo->prezzo_confermato}}" />
	...
	<div class="row">
		...
		<div class="btn-group btn-group-top-space">
        	<a target="new" href="{{url('/preventivi/pdf/quote/') . '/' . $preventivo->id}}" class="btn btn-default" title="Vedi preventivo"><i class="fa fa-file-pdf-o"></i></a>
        </div>
        </div>
    </div>    
    ...
    $(".js-example-basic-single").select2();
    	...
    	<div class="col-md-12"><h4>Pacchetti e Optional</h4><hr></div>
    <div class="col-md-2">    
    	<div class="space20"></div>    
         <a target="new" href="{{url('/preventivi/optional') . '/' . $preventivo->id}}" class="btn btn-info"  title="Vedi Optional già inseriti"><i class="fa fa-info"></i></a>
    ...
    <input value="{{$preventivo->valenza}}" type="text" id="valenza" name="valenza" placeholder="Valenza del preventivo" class="form-control"><br>
				<label for="scontoagente">Sconto agente <span class="required">(%)</span></label>
    ...
    <input value="{{$preventivo->finelavori}}" type="text" id="finelavori" name="finelavori" placeholder="Data presunta fine lavori" class="form-control"><br>
				<label for="scontobonus">Sconto bonus agente <span class="required">(%)</span></label>
    ...
    <div id="paymethod"><table class="table table-striped table-bordered">
				...
				<label for="subtotale">Totale <span class="required">(€)</span><a onclick="calcola()" class="" title="Compilazione assistita">  Clicca <i class="fa fa-info"></i> per compilazione</a></label>
    ...
    <label for="totale">Totale scontato <span class="required">(€)</span></label>
    <input value="{{$preventivo->totale}}" type="number" step=any id="totale" name="totale" placeholder="Prezzo totale" class="form-control" title="Valore scontato oppure valore sovrascritto"><br>
		...
		<div class="row">
			<div class="col-md-4">
				...
				<label for="totaledapagare">Da pagare <span class="required">(€)</span></label>
	...
	<div class="col-md-4">
		...
		<select name="statoemotivo" class="form-control" id="statoemotivo">
			...
			@if($statoemotivoselezionato!=null)
				@foreach($statiemotivi as $statoemotivo)
					<option @if($statoemotivo->id == $statoemotivoselezionato->id_tipo) selected @endif  value="{{$statoemotivo->name}}">{{$statoemotivo->name}}</option>
				@endforeach
			@else
				@foreach($statiemotivi as $statoemotivo)
        ...
        <div class="col-md-12" id="prezzo" <?php if((Auth::user()->dipartimento == 2 ) || (Auth::user()->id == 0 )){ ?>  <?php } else{?> <?php }?>>
