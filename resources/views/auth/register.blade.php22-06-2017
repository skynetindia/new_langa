    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Registrazione per Easy LANGA Server</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
						...
						<div class="form-group{{ $errors->has('dipartimento') ? ' has-error' : '' }}">
                            <label for="dipatimento" class="col-md-4 control-label">Profilazione               </label>
                        ...
                        <div class="form-group">
                            ...
                            <button class="btn btn-default"><a style="color:#000000" href="http://easy.langa.tv/login">Indietro</a></button>
                                <button type="submit" class="btn btn-warning">
                                    <i class="fa fa-btn fa-user"></i> Invia registrazione
                                </button>
                            </div>
                        </div>
                    </form>
