            ...
            <div class="left-side">            
              ...
              <div class="row">
               @foreach($quizdemodettagli as $quizdemodettagli)	              
                <div class="col-md-6">
                  <div class="item-wrapper"> <img  src="{{ URL::to('/storage/app/images/quizdemo/'.$quizdemodettagli->immagine) }}" class="img-responsive getselect" id="select<?php echo $i; ?>" alt="{{ $quizdemodettagli->nome }}" onclick="getQuizDetails('<?php echo $quizdemodettagli->id;?>','<?php echo $quizid;?>', this);">
         ...
         <script>	
            ...
            <div class="step-footer">
              ...
              <ul class="list-inline">
                ...
                <a class="none next-step" id="step_twonext"> {{ trans('messages.keyword_next') }} </a></li> 
              </ul>
            </div>
