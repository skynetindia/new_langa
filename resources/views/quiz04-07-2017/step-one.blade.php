...
<div class="col-md-12">
    ...
    <div class="wizard">
      ...
      <div class="step-content">
        <div class="step-pane">
          <form role="form" name="step_one" class="text-center register-for-quiz-form" method="post" enctype="multipart/form-data">
...
<center>
  <?php if(isset($payment_status->payment_status) && $payment_status->payment_status == 1) { ?>
    <button id="firm" class="btn btn-default none" >
  ...
  <?php if(isset($payment_status->payment_status) && $payment_status->payment_status == 2) { ?>
    <button id="down_payment" class="btn btn-default none">
   ...
   $('#nome_azienda').on('keyup',function(){
    ...
    $("#step-one").click(function(e){
        ...
        e.preventDefault();
          ...
          // var logo = new FormData($("#step_one")[0]);
