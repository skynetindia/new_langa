        ...
        <div class="step-pane">
          <form role="form" name="step_three" class="text-center register-for-quiz-form" method="post">
            ...
            <input type="hidden" name="quizid" id="quizid" value="{{ $quizid}}"/>
             ...
             <textarea name="pages" id="pages" cols="100">{{ $oldquiz->pagine }}</textarea>
                     </div>
                </li>
                ...
                <li><label> {{ trans('messages.keyword_what_colors_you_like') }} ? <span class="required">(*)</span> </label> 
                  <div class="form-group">
                      <div class="input-group">
                        <input type="text" class="form-control color no-alpha" value="<?php echo isset($oldquiz->colore_primario) ? $oldquiz->colore_primario : '#f37f0d'; ?>" id="colore_primario"
                 ...
                 <div class="form-group">
                     <div class="input-group">
                      <input type="text" class="form-control color " value="<?php echo isset($oldquiz->colore_secondario) ? $oldquiz->colore_secondario : '#f37f0d'; ?>" name="colore_secondario" placeholder=" {{ trans('messages.keyword_secondary_color') }} " id="colore_secondario">
                      <span class="input-group-addon"> {{ trans('messages.keyword_color_picker_goes_here') }} </span> 
                       </div>
                </div>
                ...
                <div class="form-group">
                     <div class="input-group">
                      <input type="text" class="form-control color" value="<?php echo isset($oldquiz->colore_alternativo) ? $oldquiz->colore_alternativo : '#f37f0d'; ?>" name="colore_alternativo" placeholder="{{ trans('messages.keyword_alternative_color') }} " id="colore_alternativo">
                      <span class="input-group-addon">{{ trans('messages.keyword_color_picker_goes_here') }} </span> 
                       </div>
                </div>
                 </li>
