    ...
    <div class="wizard">
      ...
      <div class="step-content step-four">
        <div class="step-pane">
          ...
          <?php //dd($cart); ?>
          <div class="col-md-12">
            <textarea name="get_lable" id="get_lable" cols="100">{{ $cart }}</textarea>
          </div>
          <br>
         <!--  <div class="col-md-12">
  ...
  $('#next_stepfour').click(function() {
   ...
   function setdiv(i) {
      ...
      $("#logo_add").click(function(e){
          ...
          if ($.inArray(label, push) == -1)
          {
            push.push(label);  

            $('#get_lable').append($("#icon_label").text() + ',' );
            $('.tag-editor').append("<li><div class='tag-editor-spacer'>&nbsp;,</div><div class='tag-editor-tag'>"+ label +"</div><div class='tag-editor-delete'><i></i></div></li>");
...
<script>
  ...
  ;(function($){
        ...
        $(function() {
            $('#get_lable').tagEditor({
                placeholder: '{{ trans('messages.keyword_cart') }}...',
