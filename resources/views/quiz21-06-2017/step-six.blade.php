    ...
    <div class="wizard">
      <div class="wizard-inner">
        ...
        <ul class="nav nav-tabs">
          ...
          <li role="presentation" class="top0 disabled"> <a href="#" title="Step 3"> <span class="round-tab"> <img src="{{ url('/images').'/edit.png' }}"> </span> <span class="tab-name"> {{ trans('messages.keyword_colors__layouts') }}</span> </a> </li>
          <li role="presentation" class="top0 disabled"> <a href="#" title="Complete"> <span class="round-tab"> <img src="{{ url('/images').'/list.png' }}"> </span> <span class="tab-name"> {{ trans('messages.keyword_optional') }} </span> </a> </li>
          <li role="presentation" class="top0 disabled"> <a href="#" title="Complete"> <span class="round-tab"> <img src="{{ url('/images').'/media.png' }}"> </span> <span class="tab-name"> {{ trans('messages.keyword_media') }} </span> </a> </li>
      ...
      <div class="step-content step-two step-six">
            ...
            <div class="left-side col-md-6">
              ...
              <div class="row"> 
                ...
                <div class="col-md-8">         
                  ...
                  <p id="ediscount" title="select method"> {{ trans('messages.keyword_balance_on_delivery') }}:  @isset($ediscount) {{ $ediscount }}€ @endisset + IVA @isset($etax) {{ $etax }}€ @endisset </p>
            	...
            	<div class="col-md-8"> <hr>
                  ...
                  <span id="tdiscount" title="select method"> {{ trans('messages.keyword_topay') }}: @isset($tdiscount) {{ $tdiscount }}€ @endisset + IVA  @isset($ttax) {{ $ttax }}€ @endisset
                  </span>
                </div>
                
                <div class="col-md-4">     <div class="height30"></div> 
                  <button id="confirm" class="btn btn-warning" disabled="disabled"> {{ trans('messages.keyword_confirm') }} </button>
                </div> 
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-3">
                   <img src="{{ asset('storage/app/images/LANGA-WEB_LOGO.jpg') }}" height="50" width="50">
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-3">
                  <img src="{{ asset('storage/app/images/stemma.jpg') }}" height="50" width="50">
                </div>
            	...
            	<div class="row">
                	<div class="col-md-12"><textarea name="emailid" id="emailid" cols="100"></textarea></div>
                    <div class="col-md-12">  <button class="btn btn-warning" id="sendEmail"> {{ trans('messages.keyword_send') }} </button></div>
                </div>
