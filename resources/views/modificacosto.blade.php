    ...
    <form action="{{url('/costo/aggiorna') . '/' . $costo->id}}" method="post" name="cost" id="cost">
        {{ csrf_field() }}             
             <div class="form-group">
             	<label>{{ trans('messages.keyword_object') }} : </label><input type="text" name="oggetto" value="{{$costo->oggetto}}" class="form-control required-input"> 
             </div>
             <div class="form-group">
             	<label>{{ trans('messages.keyword_cost') }} : </label> <input type="text" name="costo" value="{{$costo->costo}}" class="form-control required-input">
             </div>
             <div class="form-group">
             	<label>{{ trans('messages.keyword_insertion_date') }} : </label> 
                <input type="text" id="datainserimento" name="datainserimento" readonly="readonly" value="{{$costo->datainserimento}}" class="form-control required-input">
             </div>
