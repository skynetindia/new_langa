                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            ...
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    <li><a href="{{url('/')}}"><i class="fa fa-home"></i>{{ trans('messages.keyword_dashboard') }}</a>
                                    </li>
                                    ...
                                    foreach ($module as $module) {
                                        ...
                                        ?>
                                        <li>
                                            <a><i class="fa {{$module->modulo_class}}"></i>{{ trans('messages.'.$module->phase_key.'') }} <span class="fa fa-chevron-down"></span></a>                                  
                                       ...
                                       $submodule = DB::table('modulo')
                                        ...
                                        <li>
                                           <?php if($module->modulo_link != ""){
                                               ?>
                                    <a href="{{url('/valutaci')}}"><i class="fa fa-star-o"></i>{{ trans('messages.'.$module->phase_key.'') }}</a>
                                <?php
                                           }else{
                                               ?>
                                               <a><i class="fa {{$module->modulo_class}}"></i> {{ trans('messages.'.$module->phase_key.'') }} <span class="fa fa-chevron-down"></span></a>
