...
<h1> {{ trans('messages.keyword_addbonusdisc') }}</h1><hr>
<style>
table tr td {
	text-align:left;
...
<?php echo Form::open(array('url' => '/admin/tassonomie/scontibonus/store', 'files' => true, 'id' => 'addbonusform', 'name'=> 'addbonusform')) ?>
	...
	<div class="col-md-4">
		...
		<input value="{{ old('sconto') }}" class="form-control" type="number" name="sconto" id="sconto" placeholder="{{ trans('messages.keyword_discounts') }}"><br>
	</div>
