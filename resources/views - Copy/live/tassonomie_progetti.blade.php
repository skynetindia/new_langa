...
<fieldset>
  ...
  <form action="{{url('/admin/tassonomie/nuovostatoprogetto')}}" method="post">
    {{ csrf_field() }}
    <div class="row">
      <div class="col-md-4">
  ...
  <h4>Modifica stato emotivo progetto</h4>
  <div class="table-responsive">
    <table class="table table-striped table-bordered text-right">
      @foreach($statiemotiviprogetti as $statoemotivotipo)
      <tr>
        <td><form action="{{url('/admin/tassonomie/aggiornastatiprogetti')}}" method="post">
            {{ csrf_field() }}
            ...
            <table class="table sub-table">
              <tr>
                ...
                <td><input type="submit" class="btn btn-primary" value="Salva">
                  <a  onclick="conferma(event);" type="submit" href="{{ url('/admin/tassonomie/statiprogetti/delete/id' . '/' . $statoemotivotipo->id)}}" class="btn btn-danger">Cancella </a></td>
              </tr>
            </table>
          </form></td>
      </tr>
