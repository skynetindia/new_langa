...
<div class="col-md-12">
    <div class="col-md-8">
    <?php echo Form::open(array('url' => '/estimates/modify/quote/'. $preventivo->id, 'files' => true)) ?>
...
<input type="hidden" id="hdPrezzo" name="prezzo" value="{{$preventivo->prezzo_confermato}}" />
		...
		<div class="btn-group">
        	<a target="new" href="{{url('/estimates/pdf/quote/') . '/' . $preventivo->id}}" class="btn" title="Vedi preventivo" style="display:inline;background-color:#DDD"><i class="fa fa-file-pdf-o"></i></a>
        </div>
        <br>
