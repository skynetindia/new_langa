...
<button class="btn btn-primary" type="button" name="add" title="{{ trans('messages.keyword_addrole') }}"><i class="glyphicon glyphicon-plus"></i></button>
...
<div class="table-responsive table-custom-design">
    ...
    <thead>
        <th data-field="ruolo_id" data-sortable="true">
        {{ trans('messages.keyword_id') }} </th>
        <th data-field="nome_ruolo" data-sortable="true">
        {{ trans('messages.keyword_role') }} </th>
    </thead>
...
function check() { return confirm("{{ trans('messages.keyword_sure') }} " + n + " {{ trans('messages.keyword_role') }} ?"); }
