...
<div class="quiz-tips"><h1>Ma cosa abiamo qui!</h1><p>Diversi esempi di come potrebe ventire il tuo sito</p></div>
<div class="footer-svg">
  <img src="http://betaeasy.langa.tv/images/quiz-1.svg" alt="Quiz 1">
</div>
</div>-->
      ...
      <div class="modal-body">
        ...
        @foreach($optional as $option)
            ...
            <div style="display: none;">
              ...
              <img src="{{ (isset($option->immagine) && $option->immagine != '') ? asset('storage/app/images/'.$option->immagine) : '' }}" 
            ...
            <div class="right-description">
            	<div class="description-heading">
                    ...
                    <div class="description">                        
                        <div class="desciption-img" id="imgnotfound" style="<?php echo (isset($default->immagine) && $default->immagine != "") ? '' : 'display: none'; ?>">                          
                            <img src="{{ asset('storage/app/images/'.$default->immagine) }}" alt="{{ $default->label }}"  id="icon_immagine">
                        </div>
