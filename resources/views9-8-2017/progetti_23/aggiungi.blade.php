...
<div class="row">
  ...
  <div class="col-md-8">
    ...
    <div class="col-md-4">
		  <label for="preventivo"> {{ trans('messages.keyword_noproject') }} </label>
      ...
      <input value="{{ old('nomeprogetto') }}" class="form-control" type="text" name="nomeprogetto" id="nomeprogetto" placeholder=" {{ trans('messages.keyword_enterprojectname') }} ">
		</div>
  ...
  <div class="col-md-4">
    ...
    <div class="col-md-6">
      	...
      	<label for="tempo"> {{ trans('messages.keyword_starttime') }} </label><br>
		    ...
		    <input value="" class="form-control" type="text" name="datainizio" id="datainizio" placeholder="{{ trans('messages.keyword_startdate') }} ">
  	</div>

  	<div class="col-md-6">
      	<label for="preventivo"> {{ trans('messages.keyword_endtime') }} </label><br>
		    <input value="" class="form-control" type="text" name="datafine" id="datafine" placeholder=" {{ trans('messages.keyword_enddate') }} "><br>
  	</div>
    ...
    <script>
		...
		<div class="col-md-12">
				...
				<label for="preventivo"> {{ trans('messages.keyword_sensitivedata') }}: </label>
        <br>
