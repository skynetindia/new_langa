        ...
        <table id="table" class="table table-bordered packages_and_optional">
            ...
            <tr>
                ...
                <td><input name="oggetti[]" class="form-control" type="text" value="{{$valopp->oggetto}}">
                    <div class="row">
                        <div class="col-md-6"><input name="qt[]" class="form-control qt" type="number" value="{{$valopp->qta}}"></div>
                        <div class="col-md-6"><input name="pru[]" class="form-control pr" type="number" value="{{$valopp->prezzounitario}}"></div>
                    </div>
                </td>
                <td><input name="desc[]" class="form-control" type="text" value="{{$valopp->descrizione}}"></td>                
                <td><input name="tot[]" class="form-control tot" type="number" value="{{$valopp->totale}}">
                <div class="row">
                        <div class="col-md-6"><select name="cicli[]" class="form-control">
	...
	<div class="col-md-4">
		...
		<div class="form-group">
            ...
            <select name="statoemotivo" class="form-control" id="statoemotivo">
                ...
                @if($statoemotivoselezionato!=null)
                    @foreach($statiemotivi as $statoemotivo)
                        <option @if($statoemotivo->id == $statoemotivoselezionato->id_tipo) selected @endif style="background-color:{{$statoemotivo->color}};color:#ffffff" value="{{$statoemotivo->name}}">{{wordformate($statoemotivo->name)}}</option>
                    @endforeach
                @else
                    @foreach($statiemotivi as $statoemotivo)
                        <option  value="{{$statoemotivo->name}}">{{wordformate($statoemotivo->name)}}</option>
                    @endforeach
                @endif
            </select>
		</div>
