...
<div class="row">
	...
	<div class="col-md-3">
	    ...
	    <input type="text" name="emissione" id="emissione" class="form-control required-input error" value="{{$tranche->emissione}}">
			</div>
	...
	<div class="col-md-4">
        ...
        <div class="form-group"> 
		    ...
		    <input value="{{$tranche->datascadenza}}" class="form-control required-input error" name="datascadenza" id="datascadenza"></input>
            </div>
