        ...
        jn(function(e) {
           jn(".knob").knob({
                ...
                draw : function () {
                    ...
                    var countDownDate = new Date("<?php echo dateFormat($progetto->datainizio,'d-m-Y'); ?>").getTime();                   
                    // Update the count down every 1 second
                    var x = setInterval(function() {
                      // Get todays date and time
                      <?php
                      if(strtotime(dateFormat($progetto->datafine,'d-m-Y')) <= strtotime(date("Y-m-d")))
                      {
                        ?>
                          var now = new Date().getTime();
                          //console.log(new Date());
                      <?php  }  else   { ?>
                         var now = new Date("<?php echo dateFormat($progetto->datafine,'d-m-Y'); ?>").getTime();
                      <?php   }   ?>
