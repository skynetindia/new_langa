      ...
      <div class="step-content step-three">
        <div class="step-pane">
          <form role="form" name="step_three" class="text-center register-for-quiz-form" method="post">
            <ol>
              <li><label> {{ trans('messages.keyword_which_pages_you_like') }} ? <p style="color:#f37f0d;display:inline">(*)</p> </label>
            ...
            <input type="hidden" name="quizid" id="quizid" value="{{ $quizid}}"/>
             ...
             <textarea name="pages" id="pages" cols="100">
               {{ $oldquiz->pagine }}
             </textarea>
                     </div>
                </li>
                <span id="span_pages" style="display: none;"> {{ trans('messages.keyword_pages_required') }}  </span>                
                
                <li><label> {{ trans('messages.keyword_what_colors_you_like') }} ? <p style="color:#f37f0d;display:inline">(*)</p></label>
                <div class="form-group">
                     <div class="input-group">
                      <input type="text" class="form-control color no-alpha" value="{{ $oldquiz->colore_primario }}" id="colore_primario"
                      name="colore_primario" placeholder=" {{ trans('messages.keyword_primary_color') }} ">
                      <span class="input-group-addon"> {{ trans('messages.keyword_color_picker_goes_here') }}  </span> 
                       </div>
                </div>
                 ...
                 <div class="form-group">
                     <div class="input-group">
                      <input type="text" class="form-control color " value="{{ $oldquiz->colore_secondario }}" name="colore_secondario" placeholder=" {{ trans('messages.keyword_secondary_color') }} " id="colore_secondario">
                      <span class="input-group-addon"> {{ trans('messages.keyword_color_picker_goes_here') }} </span> 
                       </div>
                </div>
                ...
                <div class="form-group">
                     <div class="input-group">
                      <input type="text" class="form-control color" value="{{ $oldquiz->colore_alternativo }}" name="colore_alternativo" placeholder="{{ trans('messages.keyword_alternative_color') }} " id="colore_alternativo">
                      <span class="input-group-addon">{{ trans('messages.keyword_color_picker_goes_here') }} </span> 
                       </div>
                </div>
                 </li>
        ...
        if (colore_primario.value == '') {
          ...
          $.ajax({
            ...
            success:function(data) {
              ...
              var quizid = $("#quizid").val();
              currenrUrl = document.location = url+"/quiz/stepfour/"+quizid;     
            }
