...
<div class="form-group">
  ...
  <div class="form-group" id="zone_section" <?php if(isset($utente->dipartimento) && ( $utente->dipartimento == 1 || $utente->dipartimento == 3)) { ?> style="display: none" <?php } ?>>
    ...
    <div class="row">
      <div class="col-md-9 col-sm-12 col-xs-12 m_select m_select-set-width" id="zone"><?php 
  ...
  $i=0;
  ?><div class="mb10-res"><select name="zone[]" class="form-control checkzone<?php echo $i;?>">
                <option style="background-color:white" selected disabled>-- select --</option>
                <?php  
...
/*if(isset($utente->id_citta))
{
  ...
  ?>
    ...
    ?>
      ...
      <div class="col-md-3 text-right space-res-btn-mselect"> <a class="btn btn-warning" id="aggiungizone"><i class="fa fa-plus"></i></a> <a class="btn btn-danger" id="eliminazone"><i class="fa fa-trash"></i></a> </div>
...
<div class="col-md-12 col-sm-12 col-xs-12" id="permissionview">
  <?php
